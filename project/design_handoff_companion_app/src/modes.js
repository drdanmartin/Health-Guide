/* =============================================================
   ...
   5 PTx modes × shared structure. 60-day = Silver, 90-day = Gold.
   ============================================================= */
    ...
    phases: {
      silver: [
        ...
        },
        {
          ...
          keys: ["8hr eating window", "3× resistance, 4× Zone 2", "Track fasting glucose + ketones 2× week"],
        },
        {
      ...
      gold: [
        {
          ...
          keys: ["Full dietary overhaul", "Baseline DEXA or InBody if available", "10hr eating window"],
        },
        {
          name: "Weeks 3–5 · Mobilize",
          goal: "Ignite fat oxidation. Resistance training enters.",
          keys: ["8hr eating window", "3× resistance, 4× Zone 2", "Blood glucose monitoring"],
        },
        {
          name: "Weeks 6–8 · Compose",
          goal: "Visible body-composition change; refine inputs based on data.",
          keys: ["Add one weekly sprint session", "Cold plunge 3× week", "Circumference measurements"],
        },
        {
          name: "Weeks 9–11 · Deepen",
          goal: "Advanced protocols. Metabolic flexibility sharpens.",
          keys: ["6hr eating window 2× per week", "Heavier lifting (5×5)", "One 24hr fast in this phase"],
        },
        {
    ...
    phases: {
      silver: [
        ...
        },
        {
          ...
          keys: ["Daily mobility 15 min", "Cold/contrast 2× week", "HRV tracking recommended"],
        },
        {
      ...
      gold: [
        ...
        },
        {
          ...
          keys: ["Daily mobility", "HRV tracking", "Cold/contrast 2× week"],
        },
        {
