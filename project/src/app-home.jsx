...
// ============================================================
// Pre-Arrival banner — shipping window + interim supplementation
// ============================================================
function PreArrivalBanner() {
  const pa = window.SHARED.preArrival;
  return (
    <section style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div>
            ...
            <h2 style={{ fontSize: 'clamp(32px, 3.6vw, 52px)', margin: 0, lineHeight: 1.05 }}>
              {pa.title}
            </h2>
          </div>
          ...
          <div style={{
            ...
            <div>
              ...
              <h3 style={{
                ...
                letterSpacing: '-0.01em', lineHeight: 1.1, margin: 0, marginBottom: 16,
                ...
                <div key={i} style={{
                  ...
                  <div>
                    <div style={{
                      ...
                      letterSpacing: '-0.005em', marginBottom: 6, color: 'var(--fg-1)',
                    }}>
                      {item.name}
                    </div>
                    <div style={{
                    ...
                    <div style={{ color: 'var(--fg-2)', fontSize: 14, lineHeight: 1.55 }}>
                      {item.role}
                    </div>
                  </div>
                </div>
